...
if __name__ == '__main__':
    parser = argparse.ArgumentParser()																# Added, accept nb epochs as input
    parser.add_argument('--nb_epochs', type=int, default=6000, help='Number of epochs')
    ...
    pbbox=[]
    bbox=[]
    total_nb_epochs=args.nb_epochs																											## ADDED
    for epoch in range(total_nb_epochs):
            for i, img in enumerate(dataloader):
                ...
                if i%10 == 0:
                    print('Epoch [{}/{}], d_loss: {:.3f}, g_loss: {:.3f} '
                          'D real: {:.3f}, D fake: {:.3f}'
                          .format(epoch, total_nb_epochs, d_loss, g_loss,
